    ...
    <div className={cx('bookings__room--list', 'grid')}>
      <div className={cx('row')}>
        <div className={cx('col c-6 m-4 l-3')}>
          <Link to={'/rooms/123'} className={cx('room--list__item--wrapper')}>
            <div className={cx('item__img--wrapper')}>
              ...
              <img className={cx('item__img__classification--img')} src={images.premiumIcon} />
            </div>
            <div className={cx('item__detail--wrapper')}>
              <div className={cx('item__detail__name')}>
                ...
                <div className={cx('item__detail__name--value', 'value')}>911</div>
              </div>
              <div className={cx('item__detail__desc')}>
                <div className={cx('item__detail__desc__type')}>Phòng đôi</div>
                <div className={cx('item__detail__desc__classification')}>Premium</div>
              </div>
              <div className={cx('item__detail__price')}>
                <div className={cx('item__detail__price__label', 'label')}>Giá :</div>
                <div className={cx('item__detail__price__value', 'value')}>1.000.000 VND/đêm</div>
              </div>
              ...
              <div className={cx('item__detail__rate')}>
                ...
                <div className={cx('item__detail__rate--quantity', 'value')}>102 lượt đánh giá</div>
              </div>
            </div>
          </Link>
        </div>
